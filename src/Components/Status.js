    ...
    <Stack className="stack">
      ...
      <motion.div ref={ref7} animate={animation7} className="grid-item">
        ...
        <p className="line-clamp">
          ...
          administrateurs conseillers appelés à exercer auprès des universités,
          des établissements d’enseignement supérieur et de recherche et des
      ...
      <motion.div ref={ref8} animate={animation8}>
        <p className="line-clamp">
          ...
          changer la somme de cotisation, lors d'une assemblée générale, qui ne
      ...
      <motion.div ref={ref8} animate={animation8} className="grid10">
        <p className="line-clamp">
          ...
          quelle que soit sa fonction n'arrête pas l'activité de l'association.
          Le membre qui démissionne ou celui renvoyé est obligé de payer les
          cotisations antérieures et celle de l'année en cours.
        </p>
      </motion.div>
      <motion.div ref={ref11} animate={animation11}>
        <p className="line-clamp">
          Article 11 Le membre démissionnaire du comité directeur doit informer
          les autorités susnommées (L'article 6) de sa démission.
        </p>
      </motion.div>
      <motion.div ref={ref11} animate={animation11}>
        <StatusContent
      ...
      <motion.div ref={ref26} animate={animation26} className="grid-item">
        ...
        <p className="line-clamp">
          ...
          conditions suivantes: Sur proposition du comité directeur Sur demande
          écrite provenant d'au moins un tiers des membres adhérents de
          l'association et soumise au président de l'association.
        </p>
      </motion.div>
      ...
      <motion.div ref={ref27} animate={animation27} className="grid28">
        <p className="line-clamp">
          ...
          même réglementations et normes de sa création et sera annoncé comme le
          stipule l'article 5.
        </p>
      </motion.div>
      <motion.div ref={ref29} animate={animation29} className="grid-item">
        ...
        <p className="line-clamp">
          Article 29 L'annonce de la dissolution de l'association n'est possible
          qu'après avoir respecté les exigences des articles 26 et 27.
        </p>
      </motion.div>
      <motion.div ref={ref30} animate={animation30} className="grid30">
        <p className="line-clamp">
          ...
          soumis aux obligations de la Loi en vigueur selon les quelles le reste
          de l'argent provenant de l'aide de l'état devra être remboursé au
          trésor de l'état.
        </p>
      </motion.div>
    </Stack>
